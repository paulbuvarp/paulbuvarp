---
title: "Hvem eier overfloden?"
date: 2026-08-04   # PLACEHOLDER — set the real date. It drives the order of
                   # the index, the homepage, the feeds and prev/next.
lang_marker: "NO"
hero: "img/hvem-eier-overfloden.jpg"
# DRAFT — Claude's wording, both lines. The alt text describes what is there;
# rewrite it in your own words. The credit names the image as generated, which
# is the point of it being there at all. Deleting heroCredit removes the line
# and, with it, the only thing on the page that says where the picture came
# from.
heroAlt: "En opplyst portal i enden av en mørk gang, omgitt av et vidt nett av lysende tråder og punkter."
heroCredit: "Bilde generert med ChatGPT, august 2026"
draft: false
# The standfirst is your own ingress, unchanged. First time that has been true.
standfirst: "Kunstig intelligens loves som inngangen til en tid med overflod og mindre arbeid. Men historien gir liten grunn til å tro at produktivitet alene skaper frihet. Spørsmålet er ikke hvor mye vi kan produsere, men hvem som eier det som produseres."
# DRAFT — Claude's wording. Metadata only: this is what search engines and
# link previews show, never the reader on the page. Shorten or replace.
description: "Om løftet av teknologisk overflod, og hvorfor produktivitet aldri har blitt til frihet uten institusjoner som fordeler den."
# DRAFT — Claude's suggestion, one concept only. See INSTALL.md.
concepts:
  - dark-reenchantment
---

I 1930 skrev økonomen John Maynard Keynes at hans barnebarn sannsynligvis ville arbeide rundt 15 timer i uka.{{< sn >}}«Economic Possibilities for our Grandchildren», skrevet mens verden gikk inn i den store depresjonen.{{< /sn >}} Produktivitetsøkningen, mente han, ville gjøre mer arbeid overflødig. Menneskeheten sto foran et teknologisk gjennombrudd som i praksis ville løse det økonomiske grunnproblemet.
